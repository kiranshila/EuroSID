...
int main(void) {
  ...
  while (1)
  {
    HAL_GPIO_TogglePin(LED_CLK_GPIO_Port,LED_CLK_Pin); //Toggle LED
...
void SystemClock_Config(void) {
  ...
  PeriphClkInit.PeriphClockSelection =
      RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_ADC12 | RCC_PERIPHCLK_ADC34;
...
static void MX_GPIO_Init(void) {
  ...
  /*Configure GPIO pins : GATE_1_Pin GATE_2_Pin GATE_3_Pin VOICE_SW_Pin */
