...
void writeVoiceEnv(SID *sidChip, int voice) {
  ...
  writeSID(sidChip, VOICE_1_ATTACK_DECAY+ (voice * VOICE_REGISTER_OFFSET), attack_decay);
  writeSID(sidChip, VOICE_1_SUSTAIN_RELEASE + (voice * VOICE_REGISTER_OFFSET), sustain_release);
}
